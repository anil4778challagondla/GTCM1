...
public class TextQuiz extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adapter=new SurveylistAdapter(this, EventList,"quiz");
    ...
    public void Offerdata(){
        ...
        String url="http://151.106.38.222:92/api/GetQuizList?pgsize=-1&pgindex=1&str=&sortby=1&orgid=1&gid=0&pid=1";
                    ...
                    public void onResponse(JSONArray response) {
                        ...
                        for (int i = 0; i < response.length(); i++) {
                            try {
                                ...
                                Event.setSurveyId(obj.getString("QuizId"));
                                Event.setSurveyimage(obj.getString("QuizImagepath"));
                                Event.setSurveyName(obj.getString("QuizName"));
                                EventList.add(Event);
