...
import com.gmi.gtcm.Adapter.GroupsAdapter;
...
public class GroupsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adapter = new GroupsAdapter(this, movieList);
        ...
        String url ="http://151.106.38.222:92/api/GetCustomerSubscribedGroups?orgid=1&cid="+custid;
        Log.d("test", url);
                        ...
                        if(response.toString().contains("GroupName")){
                            for (int i = 0; i < response.length(); i++) {
                                try {
                                    ...
                                    movie.setOrgId(obj.getString("IsCommiteeMember"));
                            ...
                            dialog = new Dialog(GroupsActivity.this);
                            ...
                            okbtn.setOnClickListener(new View.OnClickListener() {
                                ...
                                public void onClick(View v) {
                                    dialog.dismiss();
                                    startActivity(new Intent(GroupsActivity.this, Home.class));
                                    finish();
