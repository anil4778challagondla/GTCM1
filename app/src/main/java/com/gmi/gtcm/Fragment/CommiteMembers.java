...
import com.gmi.gtcm.Adapter.CommitteemessageAdapteer;
 ...
 */
public class CommiteMembers extends Fragment implements CommitteInterface {
    private List<MessageModel> movieList = new ArrayList<MessageModel>();
    private ListView listView;
    private ProgressDialog pDialog;
    SharedPreferences sharedPreferences;
    private CommitteemessageAdapteer adapter;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v= inflater.inflate(R.layout.fragment_commite_members, container, false);
        listView = (ListView)v.findViewById(R.id.committeMessageboardlistid);
        adapter = new CommitteemessageAdapteer(getActivity(), movieList,this);
        ...
        String url = "http://151.106.38.222:92//api/getcommitteegroupmessages?orgid=1&grpid=0&cid="+custid+"&pgsize=-1&pgindex=1&str&sortby=1";
        Log.d("testlink", url);
